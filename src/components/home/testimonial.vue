            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <carousel :className='"testimonial-carousel "' :loop=true :margin=30 :items=1 :center=true :nav=true :dots=false :dotsEach=false :autoplay=false :responsive="{0:{items:1,dots:true,nav:false},768:{items:1,dots:true,nav:false},992:{nav:true}}">
                            <div class="testimonial-item">
                                <div class="testimonial-block">
                                    <div class="testimonial-avtar">
                                        <img :src='"@/assets/images/avatar/22.jpg"' alt="">
                                    </div>
